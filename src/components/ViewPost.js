...
function ViewPost() {
    ...
    // View single post from URL route to display post
    ...
    return (
        <>
            ...
            <div className="pageBody">
                <div className="view-post-container flex">

                    <div className="single-post-content flex">
                        <div className="view-post flex">
                            <Link to={"/"}>
                                <div>
